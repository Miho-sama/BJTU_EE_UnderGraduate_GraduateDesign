...
extern void ili9320_DrawPicture(u16 StartX,u16 StartY,u16 EndX,u16 EndY,u16 *pic);
...
extern u16 ili9320_GetCode(void);
extern void ili9320_BackLight(u8 status);
extern u16 ili9320_BGR2RGB(u16 c);
extern u16 ili9320_GetPoint(u16 x,u16 y);
extern void ili9320_DisplayStringLine(u8 Line, u8 *ptr, u16 charColor, u16 bkColor);
extern void ili9320_Display_NUM(uint16_t x, uint8_t Line,  uint32_t NUM, uint16_t charColor, uint16_t bkColor);
