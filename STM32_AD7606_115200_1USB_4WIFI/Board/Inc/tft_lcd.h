...
extern void LCD_SetTextColor(__IO uint16_t Color);
extern void LCD_SetBackColor(__IO uint16_t Color);
extern void LCD_ClearLine(uint8_t Line);
extern void LCD_Clear(uint16_t Color);
extern void LCD_SetCursor(uint16_t Xpos, uint16_t Ypos);
extern void LCD_DrawChar(uint16_t Xpos, uint16_t Ypos, const uint8_t *c, uint8_t width);
extern void LCD_DisplayString(uint16_t Xpos, uint16_t Ypos, uint8_t *ptr);
...
extern void LCD_DrawBMP(uint32_t BmpAddress);
extern void LCD_WriteBMP(const uint16_t *ptr);
extern void LCD_SetTransparent(uint8_t _mode);
extern void LCD_DrawPoints(POINT_T _offset, POINT_T *_points, uint16_t _Size, uint16_t _Color);

/*----- Medium layer function -----*/
extern void LCD_WriteReg(__IO uint16_t LCD_Reg, uint16_t LCD_RegValue);
...
//MY
extern void dis_a_num(uint16_t Xpos,uint16_t Ypos, uint8_t c);
extern void dis_char_num(uint16_t Xpos,uint16_t Ypos, uint8_t c);
extern void dis_int_num(uint16_t Xpos,uint16_t Ypos, uint16_t c);
extern void Test_FSMC_WR(uint16_t d);
extern uint16_t Test_FSMC_RD(void);
extern void Dis_PIC(const uint8_t  *p);
